  ...
  return (
    <div className="createAndShow">
      <div className="writePost">
        <textarea value={write} onChange={(e) => setWrite(e.target.value)} className="postText" rows="10" cols="50" placeholder="Comparte tu opinión"></textarea>
      </div>
      <button onClick={createPost} className="post">Publicar</button>
      <section >
        {post.map((Post) =>
